...
class TestClefEventProperties:
    ...
    def test_timestamp_property(self):
        ...
        event = ClefEvent(
            reified={"@t": "2026-01-24T10:00:00.123Z"},
            user={}
        )
    ...
    def test_message_template_property(self):
        ...
        event = ClefEvent(
            reified={"@mt": "User {UserId} logged in"},
            user={}
        )
...
class TestClefEventToJson:
    ...
    def test_to_json_compact(self):
        ...
        event = ClefEvent(
            reified={"@t": "2026-01-24T10:00:00Z"},
            user={"UserId": "alice"}
        )
